...
const page = () => {
    ...
    return (
        <main className='main'>
            <h1>Connect Destination with Fiori UI5 and Consume the URL using Fetch method</h1>

            <div className='content'>

                <p>In this example, We will create an UI5 application and consume the destination api using fetch.</p>
