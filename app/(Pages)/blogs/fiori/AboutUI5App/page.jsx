...
`{
  ...
  return (
    <div className="flex flex-col gap-5 text-gray-500 text-lg h-full">
        ...
        <h1 className="text-5xl  wrap-break-word">About Fiori UI5 Application</h1>
        ...
        <h2 className="text-4xl wrap-break-word">Types of Data Model</h2>
        
        <h4 className="text-2xl wrap-break-word">1. Resource Model(sap.ui.model.resource.ResourceModel)</h4>
        <ul className="list-disc ml-6">
        ...
        <h4 className="text-2xl wrap-break-word">2. JSON Model (sap.ui.model.json.JSONModel)</h4>
        <ul className="list-disc ml-6">
        ...
        <h4 className="text-2xl wrap-break-word">3. OData Model</h4>
        <ul className="list-disc ml-6">
        ...
        <h4 className="text-2xl  wrap-break-word">4. XML Model</h4>
        <ul className="list-disc ml-6">
        ...
        <h2 className="text-4xl wrap-break-word">Architecture of Fiori UI5 View</h2>

        <h4 className="text-2xl  wrap-break-word">1. Object (Root Class)</h4>
        <ul className="list-disc ml-6">
        ...
        <h4 className="text-2xl  wrap-break-word">2. Element (Base Class)</h4>
        <ul className="list-disc ml-6">
        ...
        <h4 className="text-2xl  wrap-break-word">3. Control (UI Component)</h4>
        <ul className="list-disc ml-6">
        ...
        <h4 className="text-2xl  wrap-break-word">4. Aggregation (Aggregate)</h4>
        <ul className="list-disc ml-6">
            <li>Aggregation defines parent-child relationship between controls.</li>
            <li>It renders <span className="text-gray-950 font-semibold">visible UI</span>, has properties, aggregations, events and used inside XML Views.</li>
        </ul>

        <h4 className="text-2xl  wrap-break-word">5. Property</h4>
        <ul className="list-disc ml-6">
        ...
        <h4 className="text-2xl  wrap-break-word">6. Event</h4>
        <ul className="list-disc ml-6">
        ...
        <h2 className="text-4xl wrap-break-word">What is Data Binding ..?</h2>
        <ul className="list-disc ml-6">
            <li>
        ...
        <h3 className="list-decimal text-3xl wrap-break-word">Types of Binding</h3>

        <h3 className="list-decimal text-2xl wrap-break-word">1. Property Binding (One Value Binding)</h3>
        <ul className="list-disc ml-6">
            <li>
        ...
        <h3 className="list-decimal text-2xl wrap-break-word">2. Element Binding (Context Binding)</h3>
        <ul className="list-disc ml-6">
            <li>
        ...
        <h3 className="list-decimal text-2xl wrap-break-word">3. Aggregation Binding (List Binding)</h3>
        <ul className="list-disc ml-6">
            <li>
        ...
        <h3 className="list-decimal text-2xl wrap-break-word">4. Expression Binding</h3>
        <ul className="list-disc ml-6">
        ...
        <h3 className="text-3xl wrap-break-word">Type of Data Binding based on Data Flow</h3>

        <h4 className="text-2xl  wrap-break-word">1. One Time Binding</h4>
        <ul className="list-disc ml-6">
        ...
        <h4 className="text-2xl  wrap-break-word">2. One-Way Binding</h4>
        <ul className="list-disc ml-6">
        ...
        <h4 className="text-2xl  wrap-break-word">3. Two-Way Binding</h4>
        <ul className="list-disc ml-6">
